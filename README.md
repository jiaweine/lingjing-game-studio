...
![登录与工作空间入口](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/auth.png)

### 2 · 新任务

从研发目标开始，而不是从模型配置开始。

![空任务工作台](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/workspace-empty.png)

### 3 · 素材输入

图片、视频、音频、日志、配置与文档进入同一个任务上下文。

![多模态素材上传](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/upload.png)

### 4 · 执行中

查看真实进度、当前任务状态，并在需要时停止执行。

![任务执行状态](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/task-running.png)

### 5 · 任务结果

结论、后续动作、团队协作和任务管理集中在同一个工作台。

![任务结果工作台](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/workspace.png)

### 6 · 证据核验

让结论能够回到截图、关键帧、日志等来源。

![证据核验](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/evidence.png)

### 7 · 持续多模态上下文

后续追问自动继承当前任务已有素材，不把上一轮上下文丢掉。

![多模态任务上下文](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/multimodal.png)

### 8 · 产品总览

控制、证据、交付与协作集中在同一个任务空间。

![产品总览](https://github.com/jiaweine/lingjing-game-studio/releases/download/readme-gallery-assets/cover.png)
